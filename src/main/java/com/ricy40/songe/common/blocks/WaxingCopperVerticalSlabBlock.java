...
public class WaxingCopperVerticalSlabBlock extends VerticalSlabBlock implements WaxingBlockList {
    public WaxingCopperVerticalSlabBlock(AbstractBlock.Properties prop) {
        super(prop);
    }
