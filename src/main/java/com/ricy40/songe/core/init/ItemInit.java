...
public class ItemInit {
	...
	public static final RegistryObject<Item> SONGE_SWORD = ITEMS.register("songe_sword",
			() -> new SwordItem(ModItemTier.SONGE, 3, -2.4f,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));

	public static final RegistryObject<Item> SONGE_PICKAXE = ITEMS.register("songe_pickaxe",
			() -> new PickaxeItem(ModItemTier.SONGE, 1, -2.8f,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));

	public static final RegistryObject<Item> SONGE_SHOVEL = ITEMS.register("songe_shovel",
			() -> new ShovelItem(ModItemTier.SONGE, 1.5f, -3.0f,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));

	public static final RegistryObject<Item> SONGE_HOE = ITEMS.register("songe_hoe",
			() -> new HoeItem(ModItemTier.SONGE, 2, -1.0f,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));

	public static final RegistryObject<Item> SONGE_AXE = ITEMS.register("songe_axe",
			() -> new AxeItem(ModItemTier.SONGE, 6.0f, -3.1f,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));

	//Songe Armor

	public static final RegistryObject<Item> SONGE_HELMET = ITEMS.register("songe_helmet",
			() -> new ArmorItem(ModArmorMaterial.SONGE, EquipmentSlotType.HEAD,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));

	public static final RegistryObject<Item> SONGE_CHESTPLATE = ITEMS.register("songe_chestplate",
			() -> new ArmorItem(ModArmorMaterial.SONGE, EquipmentSlotType.CHEST,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));

	public static final RegistryObject<Item> SONGE_LEGGINGS = ITEMS.register("songe_leggings",
			() -> new ArmorItem(ModArmorMaterial.SONGE, EquipmentSlotType.LEGS,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));

	public static final RegistryObject<Item> SONGE_BOOT	= ITEMS.register("songe_boots",
			() -> new ArmorItem(ModArmorMaterial.SONGE, EquipmentSlotType.FEET,
					new Item.Properties().tab(Songe.SONGE_GROUP).rarity(Rarity.RARE)));
}
